...
abilitydex: dict[str, Ability] = {
    ...
    "025": ability_entry_model("Sturdy", "taking_damage", "resists one hit ko at 1 hp"),
    "026": ability_entry_model("Compound eyes"),
    "027": ability_entry_model("Shield Dust", "always", "Prevents status atacks"),
    ...
    "031": ability_entry_model("Serene Grace (DICHA)"),
