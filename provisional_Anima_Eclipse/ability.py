...
abilitydex: dict[str, Ability] = {
    ...
    "013": ability_entry_model("Angry", "stat fall", "+1 atk when other stat fall"),
    ...
    "024": ability_entry_model("Battle Armor", "taking_damage", "can't take critical damages"), 
    "025": ability_entry_model("Sturdy", "taking_damage", "resists one hit ko with 1 hp"),
    "026": ability_entry_model("Compound eyes", "always", "raises the accuracy of moves a 30%"),
    ...
    "038": ability_entry_model("Hustle", "dealing_damage", "raises the power of moves a 50%. but reduces its accuracy by 30%"),
    "039": ability_entry_model("Swarm", "dealing_damage", "x1.5 insect damage when hp/2"), 
    ...
    "053": ability_entry_model("Typycalize", "always", "converts neutral attacks in your TypeA & communis in your TypeB (if 2 TypeB, takes the primary)"),
    "054": ability_entry_model("Anger Point", "taking_damage", "Increases all stats by 6 if a crit lands him"),
}