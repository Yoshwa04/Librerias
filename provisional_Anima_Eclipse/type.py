...
effectiveness_chart: dict[TypeA | TypeB, DefaultDict[TypeA | TypeB, float]] = defaultdict(
    ...
    {
        TypeA.ESSENTIA:     defaultdict(lambda: 1,{TypeA.VOLUNTAS: 0.5, TypeA.FORMA: 2,}),
        TypeA.FORMA:        defaultdict(lambda: 1,{TypeA.VOLUNTAS: 2, TypeA.ESSENTIA: 0.5,}),
        TypeA.VOLUNTAS:        defaultdict(lambda: 1,{TypeA.FORMA: 0.5, TypeA.ESSENTIA: 2,}),
        ...
        TypeB.METALLUM:     defaultdict(lambda: 1,{
            ...
            TypeB.METALLUM: 0.5, TypeB.AQUA: 0.5, TypeB.ELECTRITAS: 0.5, TypeB.IGNIS: 0.5, TypeB.PSYCHICUS: 0.5
        }),
    }
)
